...
AP_IMPLEMENT_HOOK_VOID(zevent_init,(apr_pool_t *pzevent),(pzevent))
AP_IMPLEMENT_HOOK_VOID(zevent_fini,(apr_pool_t *pzevent),(pzevent))
AP_IMPLEMENT_HOOK_VOID(child_init,(apr_pool_t *pchild),(pchild))
AP_IMPLEMENT_HOOK_VOID(child_fini,(apr_pool_t *pchild),(pchild))
