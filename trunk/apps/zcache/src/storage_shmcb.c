...
void storage_shmcb_init(MCConfigRecord *mc,apr_pool_t *p)
{
    void *shm_segment;
...
void storage_shmcb_attach(MCConfigRecord *mc,apr_pool_t *p)
{
    void *shm_segment;
    apr_size_t shm_segsize;
    apr_status_t rv;
...
BOOL storage_shmcb_store(MCConfigRecord *mc,UCHAR *id, int idlen,
...
void *storage_shmcb_retrieve(MCConfigRecord *mc,UCHAR *id, int idlen, int*nlen)
{
    void *shm_segment;
    void *pdata;
...
void storage_shmcb_remove(MCConfigRecord *mc,UCHAR *id, int idlen)
{
    void *shm_segment;
...
void storage_shmcb_status(MCConfigRecord *mc,apr_pool_t *p,
